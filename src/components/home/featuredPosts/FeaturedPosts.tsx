...
function Post({ user, imageSrc, imageAlt, text, tag }: PostProps) {
  ...
  return (
    <article
      className="story-card flex flex-col w-full md:w-fit bg-white rounded-md border border-solid shadow-md border-black border-opacity-10  transition-all duration-300 ease-in-out hover:cursor-pointer hover:shadow-lg hover:scale-105 hover:z-10"
